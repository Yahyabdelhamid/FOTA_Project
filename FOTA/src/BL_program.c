...
void ParseUpperAddress(u8* Copy_u8BufData)
{
	...
	/* Get Address */
	DataDigit0 = u8AsciToHex (Copy_u8BufData[9]);
	DataDigit1 = u8AsciToHex (Copy_u8BufData[10]);
	DataDigit2 = u8AsciToHex (Copy_u8BufData[11]);
	DataDigit3 = u8AsciToHex (Copy_u8BufData[12]);
